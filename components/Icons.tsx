...
export const BusinessIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A2.25 2.25 0 0011.25 11.25H4.5A2.25 2.25 0 002.25 13.5V21M3 3h12M3 7.5h12M3 12h12m-9 3.75h3m-3 4.5h3m4.5-4.5h3m-3 4.5h3m4.5-11.25h3M21 12h-3m3 3.75h-3m3 4.5h-3M3.75 21a.75.75 0 00.75.75h15a.75.75 0 00.75-.75V3.75a.75.75 0 00-.75-.75H4.5a.75.75 0 00-.75.75v16.5z" />
  </svg>
);
...
export const BriefcaseIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.072a2.25 2.25 0 01-2.25 2.25H6.012a2.25 2.25 0 01-2.25-2.25v-4.072M20.25 14.15V9.333a2.25 2.25 0 00-2.25-2.25H6.012a2.25 2.25 0 00-2.25 2.25v4.817M20.25 14.15v2.538a2.25 2.25 0 01-2.25 2.25H6.012a2.25 2.25 0 01-2.25-2.25v-2.538M15 4.5V3a.75.75 0 00-.75-.75H9.75A.75.75 0 009 3v1.5M12 9.333V3.75" />
    </svg>
);
...
export const MegaphoneIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 100 15h8.05a7.5 7.5 0 004.292-13.116M4.5 9.75v6.75" />
    </svg>
);
...
export const ShoppingCartIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c.51 0 .962-.343 1.087-.835l1.838-5.512A1.125 1.125 0 0018.062 6H5.482l-.54-1.622A1.125 1.125 0 003.86 3H2.25z" />
  </svg>
);
...
export const CalendarDaysIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M10.5 14.25h.008v.008h-.008v-.008zm.008-3.75h.008v.008h-.008V10.5zm2.992 0h.008v.008h-.008V10.5zm-3.008 7.5h.008v.008h-.008v-.008zm2.992 0h.008v.008h-.008v-.008zm2.992-3.75h.008v.008h-.008v-.008z" />
  </svg>
);

export const ScissorsIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.848 8.25l-1.344 1.343a2.25 2.25 0 01-3.182 0l-1.344-1.343a2.25 2.25 0 010-3.182l1.344-1.343a2.25 2.25 0 013.182 0l1.344 1.343z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.848 15.75l-1.344-1.343a2.25 2.25 0 00-3.182 0l-1.344 1.343a2.25 2.25 0 000 3.182l1.344 1.343a2.25 2.25 0 003.182 0l1.344-1.343z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 9.375l6-6M10.5 14.625l6 6" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.152 11.652L21.3 3.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.152 12.348L21.3 20.5" />
    </svg>
);
...
export const PaintBrushIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.994 15.994 0 011.622-3.385m5.043.025a23.918 23.918 0 00-4.471-1.282A45.048 45.048 0 0011.25 8.25c-2.295 0-4.512.425-6.613 1.158a45.048 45.048 0 00-2.49 1.282A23.918 23.918 0 003.375 16.122m12.156 0a23.918 23.918 0 00-4.471 1.282A45.048 45.048 0 0011.25 19.75c2.295 0 4.512-.425 6.613-1.158a45.048 45.048 0 002.49-1.282A23.918 23.918 0 0015.53 16.122z" />
    </svg>
);

export const UserGroupIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.57-1.023-.095-2.317-1.182-2.317h-.644a2.25 2.25 0 00-1.908.632l-1.98 2.585.032.032.032.032c.453.453.805 1.076 1.007 1.758a6 6 0 1011.943 0c.202-.682.555-1.305 1.007-1.758l.032-.032.032-.032l-1.98-2.585a2.25 2.25 0 00-1.908-.632h-.644c-1.087 0-1.752 1.294-1.182 2.317M12 12a3 3 0 11-6 0 3 3 0 016 0z" />
  </svg>
);
