...
export const BusinessIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A2.25 2.25 0 0011.25 11.25H4.5A2.25 2.25 0 002.25 13.5V21M3.75 18h16.5M13.5 21a2.25 2.25 0 002.25-2.25V13.5A2.25 2.25 0 0013.5 11.25h-1.5m1.5 9.75v-4.5a2.25 2.25 0 00-2.25-2.25H9.75m-4.5 9.75v-4.5a2.25 2.25 0 00-2.25-2.25H3.75m16.5 0v6.75c0 .621-.504 1.125-1.125 1.125H15M3.75 12h16.5" /></svg>
);

export const UsersIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.952a4.5 4.5 0 011.13-1.853M13.5 14.25a4.5 4.5 0 01-1.13 1.853m-7.5-2.952a4.5 4.5 0 00-1.13 1.853M6.75 14.25a4.5 4.5 0 001.13-1.853M18.75 19.5A18.72 18.72 0 0022.5 12c0-8.284-8.059-15-18-15S4.5 3.716 4.5 12A18.72 18.72 0 008.25 19.5M12 12.75a4.5 4.5 0 110-9 4.5 4.5 0 010 9zm-9 4.5h18" /></svg>
);
...
export const BriefcaseIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.075c0 1.313-.964 2.411-2.21 2.531-1.246.12-2.407-.378-3.15-1.337L11.25 12.5 8.61 15.14c-.822.821-1.878 1.28-2.98 1.28H3.75c-.29 0-.575-.06-.838-.175M19.5 10.5c.414 0 .75-.336.75-.75v-3c0-.414-.336-.75-.75-.75h-3c-.414 0-.75.336-.75.75v3c0 .414.336.75.75.75h3zM19.5 10.5h-3v-3h3v3zM12 10.5c.414 0 .75-.336.75-.75v-3c0-.414-.336-.75-.75-.75h-3c-.414 0-.75.336-.75.75v3c0 .414.336.75.75.75h3zM12 10.5h-3v-3h3v3zM4.5 10.5c.414 0 .75-.336.75-.75v-3c0-.414-.336-.75-.75-.75h-3c-.414 0-.75.336-.75.75v3c0 .414.336.75.75.75h3zM4.5 10.5h-3v-3h3v3z" /></svg>
);
...
export const MegaphoneIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 100 15h8.25V6a7.5 7.5 0 00-8.25 0zM6 12H3.75" /></svg>
);

export const StarIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" /></svg>
);
...
export const ShoppingCartIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c.51 0 .962-.328 1.102-.843l1.5-4.5A1.125 1.125 0 0018 8.25h-5.25M6 18.75a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM15.75 18.75a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" /></svg>
);
...
export const Cog6ToothIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.26.716.54.962l1.086.814c.44.33.533.954.227 1.464l-1.339 2.318c-.26.45-.79.643-1.28.47l-1.246-.516c-.317-.132-.683-.132-1.001 0l-1.246.516c-.49.203-1.02.02-1.28-.47l-1.339-2.318c-.306-.51-.213-1.134.227-1.464l1.086-.814c.28-.246.477-.588.54-.962l.213-1.281z" /><path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
);
...
export const ScissorsIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M7.848 8.25l1.536.887M7.848 8.25a3 3 0 11-5.196-3 3 3 0 015.196 3zM3 13.5a3 3 0 115.196 3 3 3 0 01-5.196-3zm18 0a3 3 0 11-5.196 3 3 3 0 015.196-3zm-5.196-9a3 3 0 115.196 3 3 3 0 01-5.196-3zM3.25 9.75l6.985 4.033m.265-4.285l6.985-4.033-6.985 4.033zm11.235 8.518l-6.985-4.033 6.985 4.033z" /></svg>
);
...
export const PaintBrushIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 011.622-3.385m5.043.025a2.25 2.25 0 012.245 2.4 3 3 0 001.128 5.78m-1.128-5.78a15.998 15.998 0 00-1.622-3.385m3.385 1.62a15.998 15.998 0 00-3.388 1.62m-1.622-3.385a2.25 2.25 0 012.4-2.245 3 3 0 005.78-1.128c.142-.348.22-.729.22-1.128a4.5 4.5 0 00-2.245-8.4c-1.622 3.385-3.385 1.622-5.78 1.128a2.25 2.25 0 00-2.4 2.245c0 .399.078.78.22 1.128a3 3 0 001.128 5.78z" /></svg>
);
