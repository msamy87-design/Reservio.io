...
export const customerLogin = async (req: ExpressRequest, res: ExpressResponse): Promise<void> => {
    try {
...
export const customerSignup = async (req: ExpressRequest, res: ExpressResponse): Promise<void> => {
    try {
...
export const adminLogin = async (req: ExpressRequest, res: ExpressResponse): Promise<void> => {
    try {
